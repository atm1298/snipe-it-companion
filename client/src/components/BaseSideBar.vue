...
<template>
	...
	>
		<div class="px-6">
			<a class="flex-none text-xl font-semibold" to="#" aria-label="Brand">Brand</a>
		</div>
		...
		<nav class="flex w-full flex-col flex-wrap p-6">
			<ul class="space-y-1.5">
				<li>
					<RouterLink
						class="flex items-center gap-x-3 rounded-md py-2 px-2.5 text-sm text-slate-700 hover:bg-gray-100"
						to="/"
				...
				<li>
					<RouterLink
						class="0 flex items-center gap-x-3 rounded-md py-2 px-2.5 text-sm text-slate-700 hover:bg-gray-100"
						to="#"
					>
						<svg
							class="h-3.5 w-3.5"
